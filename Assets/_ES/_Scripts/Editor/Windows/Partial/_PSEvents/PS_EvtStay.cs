...
/// 功能 : 
/// </summary>
public class PS_EvtStay {

	System.Action m_callNew;
	System.Action<EDT_Stay> m_callRemove;
	List<EDT_Stay> list;
	bool m_isPlan;
	float duration;
	string m_title;
	...
	public PS_EvtStay(string m_title,bool m_isPlan,System.Action m_callNew,System.Action<EDT_Stay> m_callRemove,bool isDrawTime){
	...
	public void DoDraw(float duration,List<EDT_Stay> list){
	...
	void _DrawOneEvnet(int index, EDT_Stay one)
	{
		...
		EG_GUIHelper.FEG_BeginV();
		{
			...
			{
				m_lFodeout[index] = EditorGUILayout.Foldout(m_lFodeout[index], "停帧 - " + index);
				GUI.color = Color.red;
	...
	void _DrawOneEventAttrs(EDT_Stay one)
	{
